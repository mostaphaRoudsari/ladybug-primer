## ![](../../images/icons/Monthly_Bar_Chart.png) Monthly Bar Chart - [[source code]](https://github.com/ladybug-tools/ladybug-legacy/tree/master/src/Ladybug_Monthly%20Bar%20Chart.py)

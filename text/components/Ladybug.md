## Ladybug [![IMAGE](images/icons/Ladybug.png)]

![IMAGE](images/components/Ladybug.png)
...
#### Inputs
* defaultFolder_ <Optional>: Optional input for Ladybug default folder. If empty default folder will be set to C:\ladybug or C:\Users\%USERNAME%\AppData\Roaming\Ladybug\

#### Outputs
* Vviiiiiiiiiizzz!: Current Ladybug mood!!!


[Check Hydra Example Files for Ladybug](https://hydrashare.github.io/hydra/index.html?keywords=Ladybug)